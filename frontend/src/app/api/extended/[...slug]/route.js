...
export async function GET(request, { params }) {
  try {
    ...
    // In dynamic routes, params.slug is an array of path segments after /api/extended/
    ...
    if (subPath === 'funding') {
      ...
      return await handleFundingHistory(request, { market: slug[1] }); // slug[1] is the market name
    } else {
